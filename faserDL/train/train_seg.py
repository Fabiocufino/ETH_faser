...
def main():
    ...
    # -- compute parameters needed for the learning rate scheduler. 
    # -- Adjusts the learning rate during training to help the model converge better or faster.
    ...
    # Initialize the model -> 3 is just for the seg labels, the lepton is always 1 
